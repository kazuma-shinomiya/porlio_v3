  ...
  return (
    ...
    <div className="px-6 py-4">
        <Link href={route('posts.show', post.id)}>
            <h1 className="text-xl font-semibold text-gray-800 dark:text-white hover:underline">{post.title}</h1>
        </Link>
        <p className="py-2 text-gray-700 dark:text-gray-400">{post.body}</p>
